...
// parameters for city generation
	int population_size <- 100000; // number of people in the simulation
	int number_of_mini_cities <- 50; // number of mini-cities
	int city_population <- 2000; // number of people per city (constellations of mini-cities)
	int mini_city_population <- 200;
	...
	float step <- 1 #day; // the simulation step is a month
