...
// Config
	...
	list<string> production_outputs_U <- ["modular_house_lobby", "modular_house_extension", "wooden_building", "plastic_factory", "centre_loisir", "school", "company"];
	...
	production_output_inputs_U <- ["modular_house_lobby"::["m3_wood"::0.0, "kg_plastic"::129100.0], "modular_house_extension"::["m² land"::50.0, "m3_wood"::0.0, "kg_plastic"::38323.0], "wooden_building"::["m² land"::100.0, "m3_wood"::624.0, "kg_plastic"::0.0], "plastic_factory"::["m3_wood"::184000.0, "kg_plastic"::42000000.0], "kg_plastic"::["kg_coton"::16.5, "kWh energy"::6.0], "centre_loisir"::["m3_wood"::1807.0, "kg_plastic"::451902.0, "m² land"::1200], "kg_plastic"::["kg_coton"::16.5, "kWh energy"::6.0], "school"::["m² land"::5474, "kg_plastic"::0.0, "m3_wood"::661.8], "company"::["m3_wood"::35.6, "kg_plastic"::0.0, "m² land"::294.6]]; //company = school * (mean capacity of company's worker) / (mean capacity of school)
	map<string, map<string, float>>
	production_output_emissions_U <- ["modular_house_lobby"::["gCO2e emissions"::1000000.0], "modular_house_extension"::["gCO2e emissions"::30000.0], "wooden_building"::["gCO2e emissions"::300000.0], "plastic_factory"::["gCO2e emissions"::50000000.0], "centre_loisir"::["gCO2e emissions"::10000.0], "kg_plastic"::["gCO2e emissions"::0.0], "school"::["gCO2e emissions"::120000.0], "company"::["gCO2e emissions"::120000.0]];
	map<string, map<string, float>>
	supply_upkeep_U <- ["modular_house_lobby"::["m² land"::0.0, "kg_plastic"::1291.0 / 12.0], "modular_house_extension"::[ "m3_wood"::0.0, "kg_plastic"::383.23 / 12.0], "wooden_building"::["m3_wood"::6.24 / 12.0, "kg_plastic"::0.0], "plastic_factory"::["m² land"::1000000.0], "centre_loisir"::["m3_wood"::18.07, "kg_plastic"::4519.02], "school"::["kg_plastic"::0.0, "m3_wood"::(661.8 / 75.0) / (12.0 * 15.0)], "company"::["kg_plastic"::0.0, "m3_wood":: (35.6 / 75.0) / (12.0 * 15.0)]]; //temporary value for school
	...
	//mini_city_demography mini_city_neo;
...
species urbanplanning parent: bloc {
	...
	action calculate_minicities_demand {
		loop mini_ville over: mini_cities {
			...
			mini_ville.demand["school"] <- mini_ville.go_to_school / 483.0 + 1;
			mini_ville.shortage["school"] <- max(0, mini_ville.demand["school"] - mini_ville.building_supply["school"]);
			mini_ville.demand["company"] <- mini_ville.go_to_work / 26.0 + 1;
		...
		bool produce_city (mini_city mini_ville) {
			...
			// needs (resources consumed/emitted) for this demand
				...
				loop a over: autoproduction_U {
					...
					if (supply_upkeep_U.keys contains c) {
						map<string, float> upkeep_requirements <- supply_upkeep_U[c];
						if (upkeep_requirements.keys contains a) {
